...
var UserStore = /** @class */ (function () {
    ...
    UserStore.prototype.create = function (first_name, last_name, password) {
        return __awaiter(this, void 0, void 0, function () {
            var hashedPassword, conn, sql, results;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        hashedPassword = bcrypt_1["default"].hashSync(password.toString(), 10);
