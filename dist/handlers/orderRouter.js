...
var store = new ordersModel_1.OrderStore();
...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var product_id, product_quantity, user_id, orderCompletness, order;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                product_id = req.query.productId;
                product_quantity = req.query.quantity;
                user_id = req.query.userId;
                orderCompletness = (_a = req.query.orderCompletness) !== null && _a !== void 0 ? _a : false;
                return [4 /*yield*/, store.create(product_id, product_quantity, user_id, orderCompletness)];
            case 1:
                order = _b.sent();
                res.json(order);
                return [2 /*return*/];
...
var show = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, orderId, order;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                userId = req.query.userId;
                orderId = req.query.id;
                return [4 /*yield*/, store.show(userId, orderId)];
            case 1:
                order = _a.sent();
                res.json(order);
                return [2 /*return*/];
